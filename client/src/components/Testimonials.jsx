...
function Testimonials() {
  ...
  return (
    <div className='flex flex-col items-center px-6 md:px-16 lg:px-24 bg-slate-50 pt-20 pb-30'>
      <Title title='What Our Guests Say' subTitle='Discover why discerning travlers consistentaly choose QuickStay for their exclusive and luxurious accomodations around the world.' />
